<?php
//views/mailing_list/view_maling_list_detail.php
if($query->num_rows() > 0):
?>
...
<?php
// userid	first_name	last_name	email	address	state_code	zip_postal	username	password	bio	interests	num_tours
